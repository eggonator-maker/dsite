(function (Drupal, once) {
  ...
  Drupal.behaviors.articlesTagsFilter = {
    attach: function (context) {
      // Use once() on the specific scroller element, not the whole form
      const scrollers = once('articles-tags-filter', '.articles-tags-filter__scroller', context);
      
      scrollers.forEach(function(scrollerElement) {
        ...
        const hiddenSelect = form.querySelector('select[name="field_tags_target_id"]');
